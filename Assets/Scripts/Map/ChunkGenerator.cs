...
public class ChunkGenerator : MonoBehaviour
{
    ...
    private void ChunkGenerationSequence(Vector3 upcomingCubePosition, GameObject actualCubecColor, ref uint debugActualCubeCounter, ref Dictionary<Vector3, GameObject> onChunkGenerated)
    {
